...
Partial Public Class InventoryDataSet
    ...
    Partial Public Class TableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddTableRow(ByVal SKU As String, ByVal Vendor As String, ByVal Name As String, ByVal Description As String, ByVal Price As Decimal, ByVal Stock As Integer) As TableRow
            Dim rowTableRow As TableRow = CType(Me.NewRow,TableRow)
            Dim columnValuesArray() As Object = New Object() {SKU, Vendor, Name, Description, Price, Stock}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindBySKU(ByVal SKU As String) As TableRow
            Return CType(Me.Rows.Find(New Object() {SKU}),TableRow)
        End Function
    ...
    Partial Public Class TableRow
        ...
        Public Property SKU() As String
            Get
                Return CType(Me(Me.tableTable.SKUColumn),String)
            End Get
            Set
                Me(Me.tableTable.SKUColumn) = value
            End Set
        End Property
        ...
        Public Function IsNameNull() As Boolean
            Return Me.IsNull(Me.tableTable.NameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetNameNull()
            Me(Me.tableTable.NameColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function IsDescriptionNull() As Boolean
            Return Me.IsNull(Me.tableTable.DescriptionColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetDescriptionNull()
            Me(Me.tableTable.DescriptionColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IsStockNull() As Boolean
            Return Me.IsNull(Me.tableTable.StockColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetStockNull()
            Me(Me.tableTable.StockColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace InventoryDataSetTableAdapters
    ...
    Partial Public Class TableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([SKU] = @Original_SKU) AND ((@IsNull_Vendor = 1"& _ 
                " AND [Vendor] IS NULL) OR ([Vendor] = @Original_Vendor)) AND ((@IsNull_Name = 1 "& _ 
                "AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Price = 1 AND [P"& _ 
                "rice] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Stock = 1 AND [Stoc"& _ 
                "k] IS NULL) OR ([Stock] = @Original_Stock)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([SKU], [Vendor], [Name], [Description], [Price], [Stoc"& _ 
                "k]) VALUES (@SKU, @Vendor, @Name, @Description, @Price, @Stock);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SKU, Ve"& _ 
                "ndor, Name, Description, Price, Stock FROM [Table] WHERE (SKU = @SKU)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [SKU] = @SKU, [Vendor] = @Vendor, [Name] = @Name, [Descr"& _ 
                "iption] = @Description, [Price] = @Price, [Stock] = @Stock WHERE (([SKU] = @Orig"& _ 
                "inal_SKU) AND ((@IsNull_Vendor = 1 AND [Vendor] IS NULL) OR ([Vendor] = @Origina"& _ 
                "l_Vendor)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Nam"& _ 
                "e)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price))"& _ 
                " AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Stock] = @Original_Stock)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SKU, Vendor, Name, Description, Price, Stock FROM [Table] WHERE (SKU = @"& _ 
                "SKU)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.CIS036_Final_BusinessManagement.My.MySettings.Default.InventoryConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SKU, Vendor, Name, Description, Price, Stock FROM dbo.[Table]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As InventoryDataSet.TableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As InventoryDataSet.TableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As InventoryDataSet.TableDataTable = New InventoryDataSet.TableDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As InventoryDataSet.TableDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_SKU As String, ByVal Original_Vendor As String, ByVal Original_Name As String, ByVal Original_Price As Global.System.Nullable(Of Decimal), ByVal Original_Stock As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal SKU As String, ByVal Vendor As String, ByVal Name As String, ByVal Description As String, ByVal Price As Global.System.Nullable(Of Decimal), ByVal Stock As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal SKU As String, ByVal Vendor As String, ByVal Name As String, ByVal Description As String, ByVal Price As Global.System.Nullable(Of Decimal), ByVal Stock As Global.System.Nullable(Of Integer), ByVal Original_SKU As String, ByVal Original_Vendor As String, ByVal Original_Name As String, ByVal Original_Price As Global.System.Nullable(Of Decimal), ByVal Original_Stock As Global.System.Nullable(Of Integer)) As Integer
            If (SKU Is Nothing) Then
                Throw New Global.System.ArgumentNullException("SKU")
            Else
            ...
            If (Original_SKU Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_SKU")
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_SKU,String)
            End If
            If (Original_Vendor Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_Vendor,String)
            End If
            If (Original_Name Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Vendor As String, ByVal Name As String, ByVal Description As String, ByVal Price As Global.System.Nullable(Of Decimal), ByVal Stock As Global.System.Nullable(Of Integer), ByVal Original_SKU As String, ByVal Original_Vendor As String, ByVal Original_Name As String, ByVal Original_Price As Global.System.Nullable(Of Decimal), ByVal Original_Stock As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_SKU, Vendor, Name, Description, Price, Stock, Original_SKU, Original_Vendor, Original_Name, Original_Price, Original_Stock)
        End Function
    End Class
